...
import 'package:qabool_hai/app/modules/profile_tab/views/widgets/custom_expanded_icon.dart';
...
class _CustomExpansionPanelListState extends State<CustomExpansionPanelList> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int index = 0; index < widget.children.length; index += 1) {
      // Space at the top of the item when its expanded
      ...
      items.add(
        MaterialSlice(
          ...
          color: _isChildExpanded(index) ?child.expandedBackgroundColor:child.collapsedBackgroundColor,
          child: Column(
            children: <Widget>[
              header,
              AnimatedCrossFade(
                firstChild: Container(height: 0.0,padding: EdgeInsets.zero,),
      ...
      // Space at the bottom of the item when its expanded
